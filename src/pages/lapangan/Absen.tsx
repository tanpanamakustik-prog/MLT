    ...
    <div className="mx-auto max-w-md">
      ...
      <Kartu className="mb-4">
        ...
        <div className="grid grid-cols-2 gap-3 px-4 py-4">
          <div>
            <p className="text-[11.5px] text-ink-3">Jam masuk</p>
            <p className="angka text-[20px] font-semibold text-ink">{jam(absensi?.jam_masuk)}</p>
          </div>
          <div>
            <p className="text-[11.5px] text-ink-3">Jam pulang</p>
            <p className="angka text-[20px] font-semibold text-ink">{jam(absensi?.jam_pulang)}</p>
          </div>
        </div>
        {absensi?.jarak_masuk_m != null && (
          <p className="flex items-center gap-1.5 border-t border-line px-4 py-2.5 text-[12px] text-ink-2">
      ...
      {pesan && (
        <div
          className={`mb-4 rounded-lg px-3 py-2.5 text-[13px] ${
      ...
      {sudahPulang ? (
        <Kartu className="px-4 py-8 text-center">
          ...
          <p className="text-[13px] text-ink-2">Absensi hari ini sudah lengkap. Sampai jumpa besok.</p>
        </Kartu>
      ) : (
        <Kartu>
